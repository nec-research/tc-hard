...
#     results_ergo2.append(scores_df)
#     df_test['prediction'] = prediction_df['prediction']
#     df_test.to_csv(RESULTS_BASE+f"ergo2.pep+cdr3b.full.hard-split.{i}.csv", index=False)

# results_ergo2 = pd.concat(results_ergo2)
# results_ergo2.to_csv(RESULTS_BASE+"ergo2.pep+cdr3b.full.hard-split.csv", index=False)
...
#     results_ergo2.append(scores_df)
#     df_test['prediction'] = prediction_df['prediction']
#     df_test.to_csv(RESULTS_BASE+f"ergo2.pep+cdr3b.only-neg-assays.hard-split.{i}.csv", index=False)

# results_ergo2 = pd.concat(results_ergo2)
# results_ergo2.to_csv(RESULTS_BASE+"ergo2.pep+cdr3b.only-neg-assays.hard-split.csv", index=False)
...
#     results_ergo2.append(scores_df)
#     df_test['prediction'] = prediction_df['prediction']
#     df_test.to_csv(RESULTS_BASE+f"ergo2.pep+cdr3b.full.random-split.{i}.csv", index=False)

# results_ergo2 = pd.concat(results_ergo2)
# results_ergo2.to_csv(RESULTS_BASE+"ergo2.pep+cdr3b.full.random-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_ergo2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"ergo2.pep+cdr3b.only-neg-assays.random-split.{i}.csv", index=False)

results_ergo2 = pd.concat(results_ergo2)
results_ergo2.to_csv(RESULTS_BASE+"ergo2.pep+cdr3b.only-neg-assays.random-split.csv", index=False)
