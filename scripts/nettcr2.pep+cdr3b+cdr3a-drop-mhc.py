...
for i in tqdm(range(5)):
    ...
    max_cdr3ba_len = max(df_train['cdr3.alpha'].str.len().max(), df_test['cdr3.alpha'].str.len().max())
    ...
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-sampled-negs.hard-split.{i}.csv", index=False)

results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-sampled-negs.hard-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_nettcr2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cdr3a-drop-mhc.full.hard-split.{i}.csv", index=False)

results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.full.hard-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_nettcr2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-neg-assays.hard-split.{i}.csv", index=False)

results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-neg-assays.hard-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_nettcr2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cr3a-drop-mhc.only-sampled-negs.random-split.{i}.csv", index=False)
    
results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-sampled-negs.random-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_nettcr2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cdr3a-drop-mhc.full.random-split.{i}.csv", index=False)
    
results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.full.random-split.csv", index=False)
...
for i in tqdm(range(5)):
    ...
    results_nettcr2.append(scores_df)
    df_test['prediction'] = prediction_df['prediction']
    df_test.to_csv(RESULTS_BASE+f"nettcr2.pep+cdr3b+cr3a-drop-mhc.only-neg-assays.random-split.{i}.csv", index=False)
    
results_nettcr2_df = pd.concat(results_nettcr2)
results_nettcr2_df.to_csv(RESULTS_BASE+"nettcr2.pep+cdr3b+cdr3a-drop-mhc.only-neg-assays.random-split.csv", index=False)
